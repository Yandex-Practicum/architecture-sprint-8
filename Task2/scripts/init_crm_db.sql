...
INSERT INTO crm.users (id, email, phone, first_name, last_name, country, city) VALUES
    ('11111111-1111-1111-1111-111111111111', 'ivan@example.com', '+79123456789', 'Ivan', 'Petrov', 'Russia', 'Moscow'),
    ('22222222-2222-2222-2222-222222222222', 'olga@example.com', '+79234567890', 'Olga', 'Sidorova', 'Russia', 'Saint Petersburg'),
    ('33333333-3333-3333-3333-333333333333', 'sergey@example.com', '+79345678901', 'Sergey', 'Ivanov', 'Russia', 'Novosibirsk'),
...
INSERT INTO crm.prostheses (id, user_id, prosthesis_type, manufacture_date, last_tuning_date, tuning_count) VALUES
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'standard', '2024-01-15', '2024-12-15 10:30:00', 3),
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', 'premium', '2024-02-20', '2024-12-20 14:20:00', 2),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333', 'standard', '2024-03-10', '2025-01-05 09:15:00', 1),
